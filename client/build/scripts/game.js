...
var Game = function (_Phaser$Game) {
	...
	function Game() {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Game).call(this, baseSize.width, baseSize.height, Phaser.AUTO, 'content', null));

		_this.state.add('GameState', _GameState2.default, false);

		socket.on('connected', function (data) {
			console.log(data);
			_this.state.states['GameState'].initialData = data;
			_this.state.states['GameState'].socket = socket;
			_this.state.start('GameState', true, false);
		});
